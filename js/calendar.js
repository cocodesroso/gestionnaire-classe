 ...
 * @returns {number} Le numéro de colonne (-1 si aujourd'hui n'est pas dans la semaine affichée)
 */
function getTodayColumn() {
    ...
    // Comparer uniquement les dates (sans heures/minutes/secondes)
    ...
    // Convertir dimanche (0) en -1, lundi (1) en 0, mardi (2) en 1, etc.
