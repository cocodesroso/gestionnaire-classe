...
function createClassCard(classe) {
    ...
    card.addEventListener('click', function() {
        window.location.href = `trombinoscope-html.html?class_id=${classe.id}`;
    });
    card.innerHTML = `
...
function displaySearchResults(results) {
    ...
    results.forEach(student => {
        ...
        item.addEventListener('click', function() {
            window.location.href = `fiche-eleve-html.html?student_id=${student.id}&class_id=${student.class_id}`;
        });
